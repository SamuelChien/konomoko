...
function emailForUpload(params){
    var mailOptions = {
        ...
        text: 'Seller: ' + params.email
            + 'MLS: ' + params.mls + '\n'
            + 'URL: ' + params.reportUrl + '\n'
            + 'Address: ' + params.address + '\n'
            + 'Click here to approve the report: '
                + params.fullSiteUrl + '/reports/publish/' + params.reportId
    ...
    var mailOptions = {
        ...
        text: 'Thank you for choosing MangoInspect, we have received your upload for mls: ' + mls
            + " at address: " + params.address
    };
    sentEmail(mailOptions);
}
...
function emailForPurchased(buyerEmail, sellerEmail, mls, reportURL){
    ...
    var mailOptions = {
        ...
        text: 'A report - MLS:' + mls + ' has been purchased. $50 added to your balance.'
    };
    sentEmail(mailOptions);
...
function emailForReportApproved(id){

    mailOptions = {
        from: companyEmail,
        to: companyEmail,
        subject: 'A Report Has Been Published',
        text: "ReportId: " + id
    };
    sentEmail(mailOptions);
}

exports.emailForReportApproved = emailForReportApproved;
