var SnippetLogin = function() {
    var e = $("#m_login"),
        ...
        showSignUpForm = function() {
          ...
          e.find(".m-login__signup")
          .animateClass("flipInX animated") },
        backToLoginForm = function() {
          e.removeClass("m-login--forget-password"),
          e.removeClass("m-login--signup"),
          e.addClass("m-login--signin"),
          e.find(".m-login__signin")
          .animateClass("flipInX animated") },
        showForgetPasswordForm = function() {
          e.removeClass("m-login--signin"),
          e.removeClass("m-login--signup"),
          e.addClass("m-login--forget-password"),
          e.find(".m-login__forget-password")
          .animateClass("flipInX animated") },
        clickHandler = function() {
          $("#m_login_forget_password").click(function(e) { e.preventDefault(), showForgetPasswordForm() }),
          $("#m_login_forget_password_cancel").click(function(e) { e.preventDefault(), backToLoginForm() }),
          $("#m_login_signup").click(function(e) { e.preventDefault(), showSignUpForm() }),
        ...
        forgetPasswordSubmit = function() {
            ...
            //     var r = $(this),
            //         n = $(this).closest("form");
            //     n.validate({ rules: { email: { required: !0, email: !0 } } }), n.valid() && (r.addClass("m-loader m-loader--right m-loader--light").attr("disabled", !0), n.ajaxSubmit({
            //         url: "",
            //         success: function(a, l, s, o) {
            //             setTimeout(function() {
            //                 r.removeClass("m-loader m-loader--right m-loader--light").attr("disabled", !1), n.clearForm(), n.validate().resetForm(), t();
