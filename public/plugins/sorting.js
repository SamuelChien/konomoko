        ...
        jQuery('.load_more_works').on('click', function () {
            ...
            if (now_load > 0) {
                ...
                for (var i = i_start - 1; i < i_start + now_load - 1; i++) {
                    loaded_object = loaded_object + '<div class="' + addon_options.items[i].columnclass  + ' ' + addon_options.items[i].sortcategory + ' grid added">   <div class="project_box overlayParent"><a href="' + addon_options.items[i].gallery + '" class="project_img"><img alt="" src="' + addon_options.items[i].src + '" /><span class="overlay"></span><span class="project_btn">+</span></a><a href="' + addon_options.items[i].url + '" class="btn_type2">' + addon_options.items[i].title + '</a></div></div>';
                }
